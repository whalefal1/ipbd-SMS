...
public final class  CommonConstant {
    ...
    public final static String LOGIN_RESPONSE_USERNAME = "用户名不正确";
    public final static String LOGIN_RESPONSE_PASSWORD = "密码不正确";
    public final static String LOGIN_RESPONSE_SUCCESS = "登录成功";
}